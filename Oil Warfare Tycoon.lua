local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/UI-Libraries/main/Vynixius%20UI%20Library/Source.lua"))()

local windowSettings = {
    toggled = true,
    key = Enum.KeyCode.RightShift,
    theme = nil,
    title = {"Galaxy Hub", "Oil Warefare Tycoon"};
}

local window = ui:AddWindow(windowSettings);

local myTab = window:AddTab("Misc");

local mySection = myTab:AddSection("Teleports");
local myTextlabel = mySection:AddLabel("Main Teleports", {alignment = Enum.TextXAlignment.Center});
local myButton = mySection:AddButton("Capture Flag",function()
...
local myButton = mySection:AddButton("Flag Top Building",function()
...
local myButton = mySection:AddButton("Zulu",function()
...
local myButton = mySection:AddButton("Charlie",function()
...
local myButton = mySection:AddButton("Omega",function()
